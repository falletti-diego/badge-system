...
| 2026-06-08 | FASE 6.7 CloudWatch Alarms (Session 15) | 6.7 | SNS badge-alerts + email. CW Agent su EC2 (disk+mem). Docker awslogs driver → /badge/api. pino-http structured logs. 8 alarms: EC2 StatusCheck ✅, CPU ✅, disk (agent), RDS CPU ✅, storage ✅, connections ✅, API 5xx, API slow. Commit: a8dff12 |
