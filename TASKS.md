...
**Last Updated:** 2026-07-12 (Session 59: fix 2 fallimenti pre-esistenti LeaveCalendar — suite frontend 100% verde ✅)  
...
|---|---|---|---|
| **[ ] Grafici trend in Dashboard** (presenze/assenteismo per sede/mese) | Alto | Basso | `recharts` già installata in `frontend-web/package.json` ma **mai usata** — nessuna nuova dipendenza |
