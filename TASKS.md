...
**Last Updated:** 2026-07-28 (Session 84: SES DKIM verificato, richiesta sandbox-exit DENIED con controreplica dettagliata inviata — in attesa di riscontro AWS; spec+piano onboarding cliente self-service scritti e committati, pronti per l'esecuzione una volta chiuso SES)  
...
| **[ ] Onboarding cliente self-service** (wizard nel dashboard) | Alto (scala) | Alto | Oggi è ancora processo "concierge" manuale (Excel + import fatto da Dataxiom, `ONB.1`) — collo di bottiglia oltre i primi clienti |
