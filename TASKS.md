...
- [x] **Namespace `/api/admin/*` non scoped per tenant chiamante — divulgazione cross-tenant** (HIGH) — ✅ **FIXATO Session 71 (branch `worktree-admin-rbac-tenant-scoping`)**
  ...
  - **Commits:** `5dd0542` (migration 031), `fcef1582` (requireSuperadmin + gate), `b6e93c35` (clients.js), `43f2ca4` (sites.js), `0092f98`+`4d87dc6` (employees.js), `0e982180` (demo-tenants.js).
...
### 📋 Valutazione critica post-merge — Ambiente Demo Self-Service (Session 70, 2026-07-16)
