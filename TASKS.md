...
**Last Updated:** 2026-07-23 (Session 79: Fase B mobile del piano Offline Mode implementata via subagent-driven-development — coda offline, sync automatico, flusso timbratura garantito, cache read-only — code-reviewata con 2 giri di fix, incluso un bug funzionale di perdita timbrature su device condivisi trovato da un security review post-commit)  
...
| **[ ] Offline mode** (check-in in coda, sync alla riconnessione) | Alto (in teoria) | Alto | Contraddice il rischio "connettività retail instabile" dichiarato in `CLAUDE.md` — vedi anche backlog esistente `Offline Mode (~10h)` |
