...
**Last Updated:** 2026-07-23 (Session 80: Task B6 — 3 crash reali trovati e fixati testando l'Offline Mode su iPhone fisico, in corso — sessione interrotta da terminare)  
...
- [ ] **Task B6** — ⏳ **IN CORSO (Session 80)**: test su iPhone reale in corso, Build 30 pronta per il retest. 3 crash reali trovati e fixati finora (vedi Session 80 sopra): `payload`/`siteId` fuori scope in `QRScannerScreen.jsx` (commit `3b00882`, `1f6c63e`), Date perse nella cache di `MyPresencesScreen.jsx` (commit `eedf9e1`). Checklist `docs/offline-mode-test-checklist.md`: Sezioni 1-2 OK, Sezione 3 in corso (3.1-3.3 da riverificare su Build 30), Sezioni 4-8 non ancora testate
