...
**Last Updated:** 2026-07-16 (Session 71: fix RBAC cross-tenant `/api/admin/*` mergiato in `main` (PR #4) e LIVE in produzione, nuovo account `superadmin` creato e verificato)  
