...
**Last Updated:** 2 Settembre 2026 (Session 120 — Fix timezone bug in `events.js` + badge di assenza in "I Miei Turni" implementati via subagent-driven-development, mergiati su `main`, pushati, CI verde, distribuiti via OTA)  
