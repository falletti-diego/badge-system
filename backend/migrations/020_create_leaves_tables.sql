-- Migration 020: Create Leave Management tables (leaves, leave_requests, leave_saldi)
-- Source: src/migrations/022_create_leaves_tables.sql (was never in the runner's
-- migrations/ dir, so prod RDS never got these tables → leave routes 500'd).
...
-- ============================================
-- TABLE: leave_requests (Employee leave requests)
-- ============================================
...
-- ============================================
-- TABLE: leave_saldi (Leave balance tracking)
-- ============================================
